...
public class Equipment : MonoBehaviour
{
    ...
    void Start()
    {
        stuff = new bool[5] { false, false, false, false, false }; // do not change test to items[x] != null becouse items is private
        items = new CollectableObject[5] { null, null, null, null, null}; // create empty item list
    }
