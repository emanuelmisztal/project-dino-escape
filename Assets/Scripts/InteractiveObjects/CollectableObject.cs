        ...
        if (!equipment.stuff[id]) // if item is not in equipment
        {
            ...
            switch (id) // check item id
            {
                ...
                case 1: // battery for uv light
                    transform.Rotate(new Vector3(0, 0, 90)); // rotate to horizontal
                    transform.position = new Vector3(44.44f, -4.4f, 0.0f); // place in third equipment box
                    break;

                case 2: // uv light
                    transform.position = new Vector3(47.45f, -4.4f, 0.0f); // place in fourth equipment box
                    break;
                ...
                case 3: // note and key
                    ...
                    else transform.position = new Vector3(-93.55f, -4.4f, 0.0f); // it's a key, place in fifth eqipment box
                    break;
